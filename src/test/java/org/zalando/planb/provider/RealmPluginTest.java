...
public class RealmPluginTest extends AbstractSpringTest {
    ...
    public void testRealmPlugins() {
        ...
        // Assertions.assertThat(cassandraRealmPlugin_1).isInstanceOf(CassandraRealmPlugin.class);
        Realm cassandraRealm_1 = cassandraRealmPlugin_1.get("brot");
        Assertions.assertThat(cassandraRealm_1).isInstanceOf(Realm.class);
        // Assertions.assertThat(cassandraRealm_1).isInstanceOf(CassandraRealm.class);
        ...
        // Assertions.assertThat(cassandraRealmPlugin_2).isInstanceOf(CassandraRealmPlugin.class);
        Realm cassandraRealm_2 = cassandraRealmPlugin_2.get("zwiebel");
        Assertions.assertThat(cassandraRealm_2).isInstanceOf(Realm.class);
        // Assertions.assertThat(cassandraRealm_2).isInstanceOf(CassandraRealm.class);
        ...
        // Assertions.assertThat(cassandraRealm_3).isInstanceOf(CassandraRealm.class);
        ...
        // Assertions.assertThat(soapRealm_3).isInstanceOf(SoapRealm.class);
        ...
        // Assertions.assertThat(defaultRealmPlugin).isInstanceOf(CassandraRealmPlugin.class);
